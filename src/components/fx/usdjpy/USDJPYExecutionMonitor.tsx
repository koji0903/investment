    ...
    <div className="p-6 bg-slate-900/50 border border-slate-900 rounded-[32px] space-y-6 overflow-hidden relative group">
      ...
      <div className="flex items-center justify-between relative z-10">
        <div className="flex items-center gap-2">
           ...
           <div>
             <h3 className="text-xs font-black uppercase tracking-widest text-slate-400">Execution Quality</h3>
             <p className="text-[9px] text-slate-500 font-bold uppercase">Real-time Liquidity Scan</p>
           </div>
        </div>
        <div className={cn(
      ...
      <div className="grid grid-cols-2 gap-4 relative z-10">
        ...
        <div className="p-4 bg-slate-950 border border-slate-800/50 rounded-2xl flex flex-col items-center justify-center gap-1 group/item">
          <span className="text-[9px] font-black text-slate-500 uppercase">Live Spread</span>
          <div className={cn(
      ...
      <div className="space-y-3 relative z-10">
        ...
        <div className="space-y-2">
           <div className="flex justify-between items-center text-[9px] font-black text-slate-500 uppercase">
              <span className="flex items-center gap-1"><BarChart3 size={10} /> Liquidity Level</span>
        ...
        <div className="flex flex-wrap gap-2 pt-2">
           <div className={cn(
             ...
             <Activity size={10} />
             Volatility Spike: {profile.volatilitySpike ? "DETECTED" : "NORMAL"}
           </div>
           <div className={cn(
             "px-2 py-1 rounded-lg border text-[8px] font-black uppercase flex items-center gap-1.5",
             ...
             <ShieldCheck size={10} />
             Slippage: {profile.slippageRisk.toUpperCase()}
           </div>
        </div>
      </div>
      ...
      {profile.status !== "ideal" && (
        <div className="mt-2 p-3 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl flex items-center gap-3">
           ...
           <p className="text-[9px] font-bold text-slate-500 leading-tight uppercase italic">
              Expect slight execution delays. Reducing lot size is recommended.
           </p>
        </div>
      )}
    </div>
