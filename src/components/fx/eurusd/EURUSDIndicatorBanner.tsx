...
/**
 * EUR/USD 経済指標・イベント警戒インジケーター (Floating Version)
 */
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] leading-none mb-0.5">
                  {status === "normal" ? "EUR/USD Safe" : "Market Alert (EU)"}
                </span>
                <span className="text-[12px] font-bold tracking-tight">
                   {status === "normal" ? "正常稼働中" : message.replace(/【.*?】/, "")}
                </span>
              </div>
            </div>
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Impact Analysis</p>
                  ...
                  {nextEvent && (
                    <div className="p-4 bg-white/5 border border-white/5 rounded-2xl space-y-2">
                       ...
                       <div className="flex items-center justify-between pt-1">
                          ...
                          <span className="text-[10px] font-black text-slate-300">{nextEvent.currency}</span>
                       </div>
                  ...
                  <p className="text-[9px] text-center text-slate-400 font-bold italic opacity-60">
                    ※ 欧州・米国の指標発表時はスプレッド拡大に注意。
                  </p>
                </div>
              </motion.div>
            )}
